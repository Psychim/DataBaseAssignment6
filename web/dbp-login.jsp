            ...
            <div class="content-form-page">
              <div class="row">
                <div class="col-md-7 col-sm-7">
                  <form id="loginform" method="post" action="Login" class="form-horizontal form-without-legend" role="form" onsubmit="return formatcontrol('loginform');">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0">
                        <a href="dbp-forgotton-password.jsp">Forget Password?</a>
                      </div>
                    </div>
