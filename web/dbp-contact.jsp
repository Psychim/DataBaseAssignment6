...
<!-- BEGIN NAVIGATION -->
     ...
     <div class="main">
         <div class="container">
             <ul class="breadcrumb">
                 <li><a href="dbp-index.html">Home</a></li>
             ...
             <div class="row margin-bottom-40">
                 ...
                 <div class="sidebar col-md-3 col-sm-3">
                     <ul class="list-group margin-bottom-25 sidebar-menu">
                         <li class="list-group-item clearfix"><a href="dbp-help.html"><i class="fa fa-angle-right"></i> Help/Infomation</a></li>
                         <li class="list-group-item clearfix"><a href="dbp-faq.html"><i class="fa fa-angle-right"></i> F.A.Q</a></li>
                         <li class="list-group-item clearfix"><a href="dbp-system-rules.html"><i class="fa fa-angle-right"></i> System Rules</a></li>
                 ...
                 <div class="sidebar col-md-9 col-sm-9">
                     ...
                     <div class="content-page">
                         <address>
                             ...
                             <abbr title="Phone">P:</abbr> 211189<br>
                         </address>
                         <address>
                             <strong>Email</strong><br>
                             <a>email1@bookstore.com</a>
                         </address>
                     </div>
                 </div>
                 <!-- END CONTENT -->
